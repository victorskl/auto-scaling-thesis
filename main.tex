...
\supervisor{Prof. Richard \textsc{Sinnott}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\keywords{auto-scaling, scaling, container orchestration, docker, kubernetes, openstack} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\item The thesis is 9999999 words in length (excluding text in images, table, bibliographies and appendices).\\
\end{itemize}
